...
There are diagrams of Bit layout of single filter mode and Bit layout of dual filter mode, but they are described in <span style="color: red; ">Right side MSBit</span>.   
